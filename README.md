...
He is a Ph.D. student at [Ohio University](https://www.ohio.edu/) studying machine learning for game-playing agent and user interface design for augmented reality devices. He thought it was fun to help run a conference and also live debugging the production codebase for said conference. He loves to spend months automating a task that only takes a few hours to complete if done manually.
